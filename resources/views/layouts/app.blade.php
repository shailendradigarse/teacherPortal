...
<body>
    <div id="app">
        ...
        <div id="alertSuccess" class="alert alert-success alert-dismissible fade d-none fixed-top" role="alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            Success message
        </div>

        <!-- Bootstrap Alert for Error -->
        <div id="alertError" class="alert alert-danger alert-dismissible fade d-none fixed-top" role="alert">
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            Error message
        </div>
